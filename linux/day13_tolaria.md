...
`day11` 已经整理 `while`、`for`、`break`、`continue`、参数判断等 Shell 基础。本条目只保留 `day13` 中新增或更进一步的内容：`select` 菜单、数组、参数展开、函数、Expect、脚本调试、多进程并发、随机数生成。
...
| 随机数 | `$RANDOM`、`date +%s%N | md5sum`、`uuidgen` 各有适用场景 |
